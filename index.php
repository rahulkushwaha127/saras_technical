...
<body>
    ...
    <a class="navbar-brand" href="#">SARAS TECHNICAL</a>
        ...
        <div class="container-fluid">
            <div class="row">
                ...
                <div class="col-lg-6 col-md-6 col-12" >
                    ...
                    <P class=" py-3 " >Lorem ipsum dolor sit amet consectetur adipisicing elit. Quas expedita molestias 
                        nam sint debitis nobis consequuntur deserunt perspiciatis neque
                        reiciendis exercitationem alias adipisci, similique autem dolore 
                        nisi quisquam esse! Commodi!</P>
    ...
    <footer>
        <p class="p-3 bg-dark text-white text-center" >@sarastechnical2022</p>
    </footer>
